...
const sharedTables = ["children", "child_record_items", "child_documents", "child_document_confirmations", "child_actions", "child_circle_memberships", "institutional_workspace_items", "child_events", "child_event_participants", "notifications"] as const;
